...
public class Antonio extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.antonio);
        ...
        findViewById(R.id.btnMap).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("geo: 14.612545, 120.987437 ?q= 14.612545, 120.987437 (Antonio Street)"));
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                {
                    startActivity(new Intent(Antonio.this, ProfileActivity.class));
                    Toast.makeText(Antonio.this, "My Profile", Toast.LENGTH_SHORT).show();
                }
                else if(id == R.id.foodStores)
                {
                    Toast.makeText(Antonio.this, "You are in this page", Toast.LENGTH_SHORT).show();
                }
                ...
                else  if(id == R.id.signout)
                {
                    ...
                    finish();
                    startActivity(new Intent(Antonio.this, MainActivity.class));
                    Toast.makeText(Antonio.this, "You have signed out successfully", Toast.LENGTH_LONG).show();
                }
