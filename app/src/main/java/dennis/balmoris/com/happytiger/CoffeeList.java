    ...
    public void onCreate(Bundle savedInstanceStatete) {
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                {
                    startActivity(new Intent(CoffeeList.this, ProfileActivity.class));
                    Toast.makeText(CoffeeList.this, "My Profile", Toast.LENGTH_SHORT).show();
                } else if (id == R.id.foodStores) {
                    startActivity(new Intent(CoffeeList.this, FoodStores.class));
                    Toast.makeText(CoffeeList.this, "Food Stores", Toast.LENGTH_SHORT).show();
                    ...
                    finish();
                    startActivity(new Intent(CoffeeList.this, MainActivity.class));
                    Toast.makeText(CoffeeList.this, "You have signed out successfully", Toast.LENGTH_LONG).show();
                }
