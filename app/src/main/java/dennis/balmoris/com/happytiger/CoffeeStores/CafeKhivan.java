...
public class CafeKhivan extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cafe_khivan);
        ...
        findViewById(R.id.btnMap).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("geo: 14.608374, 120.987764 ?q= 14.608374, 120.987764 (Cafe Khivan)"));
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                {
                    startActivity(new Intent(CafeKhivan.this, ProfileActivity.class));
                    Toast.makeText(CafeKhivan.this, "My Profile", Toast.LENGTH_SHORT).show();
                }
                else if(id == R.id.foodStores)
                {
                    Toast.makeText(CafeKhivan.this, "You are in this page", Toast.LENGTH_SHORT).show();
                }
                else if(id == R.id.messages)
                {
                    startActivity(new Intent(CafeKhivan.this, MessageActivity.class));
                ...
                else  if(id == R.id.signout)
                {
                    ...
                    finish();
                    startActivity(new Intent(CafeKhivan.this, MainActivity.class));
                    Toast.makeText(CafeKhivan.this, "You have signed out successfully", Toast.LENGTH_LONG).show();
                }
