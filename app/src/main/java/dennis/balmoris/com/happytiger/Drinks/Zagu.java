...
public class Zagu extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                {
                    startActivity(new Intent(Zagu.this, ProfileActivity.class));
                    Toast.makeText(Zagu.this, "My Profile", Toast.LENGTH_SHORT).show();
                }
                else if(id == R.id.foodStores)
                {
                    Toast.makeText(Zagu.this, "You are in this page", Toast.LENGTH_SHORT).show();
                }
                else if(id == R.id.messages)
                {
                    startActivity(new Intent(Zagu.this, MessageActivity.class));
                    Toast.makeText(Zagu.this, "Discuss Now", Toast.LENGTH_SHORT).show();
                }

                else  if(id == R.id.settings)
                {
                    startActivity(new Intent(Zagu.this, Settings.class));
                    Toast.makeText(Zagu.this, "Settings", Toast.LENGTH_SHORT).show();
                }
                ...
                else  if(id == R.id.signout)
                {
                    ...
                    finish();
                    startActivity(new Intent(Zagu.this, MainActivity.class));
                    Toast.makeText(Zagu.this, "You have signed out successfully", Toast.LENGTH_LONG).show();
                }
