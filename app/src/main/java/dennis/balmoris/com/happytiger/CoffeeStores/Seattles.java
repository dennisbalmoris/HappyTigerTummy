...
public class Seattles extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.seattles);
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                {
                    startActivity(new Intent(Seattles.this, ProfileActivity.class));
                    Toast.makeText(Seattles.this, "My Profile", Toast.LENGTH_SHORT).show();
                }
                else if(id == R.id.foodStores)
                {
                    Toast.makeText(Seattles.this, "You are in this page", Toast.LENGTH_SHORT).show();
                }
                else if(id == R.id.messages)
                {
                    startActivity(new Intent(Seattles.this, MessageActivity.class));
                    Toast.makeText(Seattles.this, "Discuss Now", Toast.LENGTH_SHORT).show();
                }

                else  if(id == R.id.settings)
                {
                    startActivity(new Intent(Seattles.this, Settings.class));
                    Toast.makeText(Seattles.this, "Settings", Toast.LENGTH_SHORT).show();
                }
                ...
                else  if(id == R.id.signout)
                {
                    ...
                    finish();
                    startActivity(new Intent(Seattles.this, MainActivity.class));
                    Toast.makeText(Seattles.this, "You have signed out successfully", Toast.LENGTH_LONG).show();
                }
